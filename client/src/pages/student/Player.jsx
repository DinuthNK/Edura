...
const toggleSection = (index)=>{
  ...
  useEffect(()=>{getCourseData()}, [enrolledCourses, courseId])
  ...
  return (
    ...
    <div key={index} className='border border-gray-300bg-white mb-2 rounded'>
      ...
      <div className='flex items-center gap-2py-3 mt-10'>
                ...
                <div>
                   <YouTube videoId={playerData.lectureUrl.split('/').pop()} 
                    ...
                    <div className='flex justify-between items-center mt-1'>
                      ...
                      <button className='text-purple-600'>{false ? 'Completed' : 'Mark Complete'}</button>
                    </div>
                </div>
              )
              :
