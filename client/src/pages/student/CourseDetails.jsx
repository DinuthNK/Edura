...
const CourseDetails = () => {
  ...
  return (
    <>
    <div className='flex flex-col items-center justify-center w-full md:pt-36 pt-50
     px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-purple-700/80'>
 ...
 <p className='text-sm'>Course by <span className='text-blue-600 underline'>Dinuth Nadeepa</span></p>
  <div className='pt-8 text-gray-800'>
    ...
    <div className='py-20 text-sm md:texr-default'>
      ...
      <p className='pt-3 rich-text ' 
        ...
        {/* Right Column (you can design this later) */}
        <div 
  style={{
    maxWidth: '424px',
    minWidth: '300px',
    backgroundColor: 'white',
    boxShadow: '0px 4px 15px 2px rgba(0, 0, 0, 0.1)', // custom shadow
    borderTopLeftRadius: '0.5rem', // rounded-t
    borderTopRightRadius: '0.5rem',
    overflow: 'hidden',
    zIndex: 10,
    border: '1px solid #e5e7eb', // custom border color (gray)
  }}
>             { playerData ? 
          ...
          <div className='p-5'>
                  ...
                  <div className='flex gap-3 items-center pt-2'>
                    <p className='text-gray-800 md:text-2xl font-semibold'>{currency} {(courseData.coursePrice - courseData.discount * courseData.coursePrice/ 100).toFixed(2)}</p>
                    <p className='md:text-lg text-gray-500 line-through'>{currency}{courseData.coursePrice}</p>
                    <p className='md:text-lg text-gray-500'>{courseData.discount}% off</p>
                  </div>
                  <div className='flex items-center text-smmd:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
                  ...
                  <button className='md:mt-6 mt-4 w-full py-3 rounded bg-purple-600 
